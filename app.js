...
document.querySelector('#feedbackButton').onclick=()=>document.querySelector('#feedbackModal').hidden=false;
document.querySelector('#closeFeedback').onclick=()=>document.querySelector('#feedbackModal').hidden=true;
